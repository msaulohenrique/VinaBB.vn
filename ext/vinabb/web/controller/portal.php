	...
	*/
	...
	public function index()
	{
		...
		$this->template->assign_vars(array(
			...
			'LATEST_PHPBB_DOWNLOAD_URL'			=> str_replace(array('{branch}', '{version}'), array($this->config['vinabb_web_check_phpbb_branch'], $this->config['vinabb_web_check_phpbb_version']), $this->config['vinabb_web_check_phpbb_download_url']),
			'LATEST_PHPBB_GITHUB_URL'			=> str_replace(array('{branch}', '{version}'), array($this->config['vinabb_web_check_phpbb_branch'], $this->config['vinabb_web_check_phpbb_version']), $this->config['vinabb_web_check_phpbb_github_url']),
			'LATEST_PHPBB_LEGACY_VERSION'		=> $this->config['vinabb_web_check_phpbb_legacy_version'],
			'LATEST_PHPBB_LEGACY_DOWNLOAD_URL'	=> str_replace(array('{branch}', '{version}'), array($this->config['vinabb_web_check_phpbb_legacy_branch'], $this->config['vinabb_web_check_phpbb_legacy_version']), $this->config['vinabb_web_check_phpbb_download_url']),
			'LATEST_PHPBB_LEGACY_GITHUB_URL'	=> str_replace(array('{branch}', '{version}'), array($this->config['vinabb_web_check_phpbb_legacy_branch'], $this->config['vinabb_web_check_phpbb_legacy_version']), $this->config['vinabb_web_check_phpbb_github_url']),
