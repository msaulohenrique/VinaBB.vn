...
class forum
{
	...
	*/
	...
	/** @var \vinabb\web\entities\forum_desc */
	...
	*/
	public function __construct(\phpbb\db\driver\driver_interface $db, \vinabb\web\entities\forum_desc $forum_desc)
	{
		$this->db = $db;
	...
	*/
	...
	{
		return $this->forum_desc->get_desc_for_edit();
	}
	...
	*/
	...
	{
		return $this->forum_desc->get_desc_for_display($censor);
	}
