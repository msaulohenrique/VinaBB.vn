	...
	*/
	public function main($id, $mode)
	{
		...
		$this->template->assign_vars(array(
			...
			'MAINTENANCE_TEXT'			=> isset($maintenance_text) ? $maintenance_text : $data['vinabb_web_maintenance_text'],
			'MAINTENANCE_TEXT_VI'		=> isset($maintenance_text_vi) ? $maintenance_text_vi : $data['vinabb_web_maintenance_text_vi'],
