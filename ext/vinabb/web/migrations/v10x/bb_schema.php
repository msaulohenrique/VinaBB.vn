			...
			'add_tables' => array(
				...
				$this->table_prefix . 'bb_items' => array(
					'COLUMNS' => array(
						...
						'item_desc'					=> array('TEXT_UNI', ''),
						'item_desc_uid'				=> array('VCHAR:8', ''),
						'item_desc_bitfield'		=> array('VCHAR:255', ''),
						'item_desc_options'			=> array('UINT:11', 0),
						'item_desc_vi'				=> array('TEXT_UNI', ''),
						'item_desc_vi_uid'			=> array('VCHAR:8', ''),
						'item_desc_vi_bitfield'		=> array('VCHAR:255', ''),
						'item_desc_vi_options'		=> array('UINT:11', 0),
						...
						'item_lang_iso'				=> array('VCHAR:30', ''),
						'item_tool_os'				=> array('TINT:2', 0),
