	...
	*/
	protected function request_data()
	{
		$this->data = [
			...
			'item_ext_event'			=> $this->request->variable('item_ext_event', false),
			'item_ext_event_style'		=> $this->request->variable('item_ext_event_style', false),
			'item_ext_event_acp_style'	=> $this->request->variable('item_ext_event_acp_style', false),
			'item_ext_module_acp'		=> $this->request->variable('item_ext_module_acp', false),
			'item_ext_module_mcp'		=> $this->request->variable('item_ext_module_mcp', false),
			'item_ext_module_ucp'		=> $this->request->variable('item_ext_module_ucp', false),
			'item_ext_notification'		=> $this->request->variable('item_ext_notification', false),
			'item_ext_cron'				=> $this->request->variable('item_ext_cron', false),
			'item_ext_console'			=> $this->request->variable('item_ext_console', false),
			'item_ext_ext_php'			=> $this->request->variable('item_ext_ext_php', false),
	...
	protected function get_extra_map_fields($bb_mode)
	{
		...
		$data = [
			'ext'	=> [
				...
				'set_ext_event'				=> $this->data['item_ext_event'],
				'set_ext_event_style'		=> $this->data['item_ext_event_style'],
				'set_ext_event_acp_style'	=> $this->data['item_ext_event_acp_style'],
				'set_ext_module_acp'		=> $this->data['item_ext_module_acp'],
				'set_ext_module_mcp'		=> $this->data['item_ext_module_mcp'],
				'set_ext_module_ucp'		=> $this->data['item_ext_module_ucp'],
				'set_ext_notification'		=> $this->data['item_ext_notification'],
				'set_ext_cron'				=> $this->data['item_ext_cron'],
				'set_ext_console'			=> $this->data['item_ext_console'],
				'set_ext_ext_php'			=> $this->data['item_ext_ext_php']
			],
			'style'	=> [
	...
	*/
	protected function data_to_tpl(\vinabb\web\entities\bb_item_interface $entity)
	{
		$this->template->assign_vars([
			...
			'ITEM_EXT_EVENT'			=> $entity->get_ext_event(),
			'ITEM_EXT_EVENT_STYLE'		=> $entity->get_ext_event_style(),
			'ITEM_EXT_EVENT_ACP_STYLE'	=> $entity->get_ext_event_acp_style(),
			'ITEM_EXT_MODULE_ACP'		=> $entity->get_ext_module_acp(),
			'ITEM_EXT_MODULE_MCP'		=> $entity->get_ext_module_mcp(),
			'ITEM_EXT_MODULE_UCP'		=> $entity->get_ext_module_ucp(),
			'ITEM_EXT_NOTIFICATION'		=> $entity->get_ext_notification(),
			'ITEM_EXT_CRON'				=> $entity->get_ext_cron(),
			'ITEM_EXT_CONSOLE'			=> $entity->get_ext_console(),
			'ITEM_EXT_EXT_PHP'			=> $entity->get_ext_ext_php(),
