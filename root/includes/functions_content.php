...
function parse_attachments($forum_id, &$message, &$attachments, &$update_count_ary, $preview = false)
{
	...
	foreach ($attachments as $attachment)
	{
		...
		if (!$denied)
		{
			...
			$link_params = array('id' => $attachment['attach_id']);
			...
			switch ($display_cat)
			{
				...
				case ATTACHMENT_CATEGORY_IMAGE:
					$inline_link = $controller_helper->route('vinabb_web_attachment_route', $link_params);
					$link_params['mode'] = 'view';
				...
				case ATTACHMENT_CATEGORY_THUMB:
					$thumbnail_link = $controller_helper->route('vinabb_web_attachment_route', array('id' => $attachment['attach_id'], 't' => '1'));
					$link_params['mode'] = 'view';
				...
				case ATTACHMENT_CATEGORY_FLASH:
					...
					$block_array += array(
						...
						'WIDTH'			=> $width,
						'HEIGHT'		=> $height,
						'U_VIEW_LINK'	=> $controller_helper->route('vinabb_web_attachment_route', array('id' => $attachment['attach_id'], 'view' => '1')),
					);
			...
			$block_array += array(
				'U_DOWNLOAD_LINK'		=> $controller_helper->route('vinabb_web_attachment_route', $link_params),
