	...
	*/
	protected function map_set_data(\vinabb\web\entities\bb_item_interface $entity)
	{
		$map_fields = [
			...
			'set_style_presets'		=> $this->data['item_ext_db_data'],
			'set_style_presets_aio'	=> $this->data['item_ext_db_data'],
			'set_style_source'		=> $this->data['item_ext_db_data'],
			'set_style_responsive'	=> $this->data['item_ext_db_data'],
			'set_style_bootstrap'	=> $this->data['item_ext_db_data'],
